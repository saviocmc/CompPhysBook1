...
For more detailed texts on C++ programming in engineer\
ing and
...
.
The Fortran 95 standard is well documented in Refs.~\cite{f95ref,metcalf1996,marshall199\
5}
while the
...
It is therefore important than one tries to find additional literature on these programm\
ing languages.
